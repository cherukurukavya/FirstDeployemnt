...
<head>
    ...
    <title>KavyasShop - Modern E-Commerce</title>
...
<body>
    ...
    <section class="hero">
        <div class="hero-content">
            <h1>Summer Collection in 2027 Version 5</h1>
            <p>find the latest trends in fashion, technology and accessories with up to 80% off selected items</p>
